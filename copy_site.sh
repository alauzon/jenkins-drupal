...
declare "$USERNAME_VARNAME"="${SITE}_USERNAME"
USERNAME=${!USERNAME_VARNAME}

declare "SOURCE_HOME_VARNAME"="${SITE}_${SOURCE_ENV}_HOME"
SOURCE_HOME=${SOURCE_HOME_VARNAME}

declare "SOURCE_DB_NAME_VARNAME"=${SITE}_${SOURCE_ENV}_DB_NAME
SOURCE_DB_NAME=${SOURCE_DB_NAME_VARNAME}

declare "SOURCE_DB_HOST_VARNAME"=${SITE}_${SOURCE_ENV}_DB_HOST
SOURCE_DB_HOST=${SOURCE_DB_HOST_VARNAME}

declare "SOURCE_DB_PORT_VARNAME"=${SITE}_${SOURCE_ENV}_DB_PORT
SOURCE_DB_PORT=${SOURCE_DB_PORT_VARNAME}

declare "SOURCE_DB_USERNAME_VARNAME"=${SITE}_${SOURCE_ENV}_DB_USERNAME
SOURCE_DB_USERNAME=${SOURCE_DB_USERNAME_VARNAME}

declare "SOURCE_DB_PASSWORD_VARNAME"=${SITE}_${SOURCE_ENV}_DB_PASSWORD
SOURCE_DB_PASSWORD=${SOURCE_DB_PASSWORD_VARNAME}

declare "TARGET_HOME_VARNAME"=${SITE}_${TARGET_ENV}_HOME
TARGET_HOME=${TARGET_HOME_VARNAME}

declare "TARGET_DB_NAME_VARNAME"=${SITE}_${TARGET_ENV}_DB_NAME
TARGET_DB_NAME=${TARGET_DB_NAME_VARNAME}

declare "TARGET_DB_HOST_VARNAME"=${SITE}_${TARGET_ENV}_DB_HOST
TARGET_DB_HOST=${TARGET_DB_HOST_VARNAME}

declare "TARGET_DB_PORT_VARNAME"=${SITE}_${TARGET_ENV}_DB_PORT
TARGET_DB_PORT=${TARGET_DB_PORT_VARNAME}

declare "TARGET_DB_USERNAME_VARNAME"=${SITE}_${TARGET_ENV}_DB_USERNAME
TARGET_DB_USERNAME=${TARGET_DB_USERNAME_VARNAME}

declare "TARGET_DB_PASSWORD_VARNAME"=${SITE}_${TARGET_ENV}_DB_PASSWORD
